...
svg {
  ...
  #diamond,
  #bubble-rounded {
    -webkit-animation: plop 4s ease-out infinite;
    animation: plop 4s ease-out infinite;
  }
  #oval:nth-child(1),
  #plus:nth-child(1),
  #diamond:nth-child(1),
  #bubble-rounded:nth-child(1) {
